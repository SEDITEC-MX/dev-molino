		...
		while ($reg = $respuesta->fetch_object()) {
			...
			$data[] = array(
				"0" => (($reg->estado_evento == 'Programado') ? 
					'<abbr title="Ver detalle"><button class="btn btn-primary" onclick="mostrar(' . $reg->id_evento . ')"><i class="fa fa-search fa-xs"></i></button></abbr> ' .
					'<abbr title="Finalizar evento"><button class="btn btn-danger" onclick="anular(' . $reg->id_evento . ')"><i class="fa fa-close"></i></button></abbr> ' :
					'<abbr title="Ver detalle"><button class="btn btn-primary" onclick="mostrar(' . $reg->id_evento . ')"><i class="fa fa-search fa-xs"></i></button></abbr> ' .
					'<abbr title="Regresar a Programado"><button class="btn btn-warning" onclick="activar(' . $reg->id_evento . ')"><i class="fa fa-undo fa-xs"></i></button></abbr> '
				),
				"1" => $reg->fecha_evento,
				"2" => $reg->tipo_evento,
				"3" => $reg->nombre_evento,
