...

{
	...
	case 'listar' :
...

		{
			...
			"0"=>($reg->condicio_categoria_servicio)?'<botton class="btn btn-warning" onclick="mostrar('.$reg->id_categoria_servicio.')"><i class="fa fa-pencil"></i></botton>'.

			' <botton class="btn btn-danger" onclick="desactivar('.$reg->id_categoria_servicio.')"><i class="fa fa-close"></i></botton>':'<botton class="btn btn-warning" onclick="mostrar('.$reg->id_categoria_servicio.')"><i class="fa fa-pencil"></i></botton>'.
