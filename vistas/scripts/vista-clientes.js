...
function listar() {
  tabla = $("#tbllistado")
    .dataTable({
      ...
      ajax: {
        url: "../ajax/vistas.php?op=listarVistaClientes",
        type: "get",
        dataType: "json",
        error: function (e) {
...
function agregarDetalle(id_servicio, nombre_servicio, categoria_servicio) {
  ...
  if (id_servicio != "") {
    ...
    var fila =
      ...
      categoria_servicio +
      "</td>" +
      '<td><input type="number" name="cantidad_detalle_evento[]" id="cantidad_detalle_evento[]" value="' +
      cantidad_detalle_evento +
      '"></td>' +
      '<td><input type="number" name="precio_detalle_evento[]" id="precio_detalle_evento[]" value="' +
