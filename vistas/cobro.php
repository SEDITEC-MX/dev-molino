...
?>
  ...
  <?php if (strpos($_SESSION['checkboxes'], 'd') !== false) { ?>
              ...
              <div class="panel-body" id="listadoregistros">
                <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover" style="width: 100% !important;">
                  <thead>
                    ...
                    <th style="text-align: center; vertical-align:middle;">Cobrado</th>
                    <th style="text-align: center; vertical-align:middle;">Pendiente</th>
    ...
    <script type="text/javascript" src="scripts/cobro.js"></script>
    <!-- --------------------------------------------------------------------------------------------------------------------------------------------- -->
  <?php
  }
  // Cerramos buffer
