          ...
          <div class="col-md-12">
            <div class="box">
              ...
              <div class="box-header with-border">
                <h1 class="box-title">Registrar gasto de Caja Chica &nbsp; &nbsp;
            ...
            <button class="btn btn-success" id="boton_verde_agregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button> -->
              ...
              <div class="panel-body table-responsive" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <input type="hidden" id="id_usuario" data-id-usuario="<?php echo $_SESSION['id_usuario']; ?>" value="<?php echo $_SESSION['id_usuario']; ?>" />
                  <!-- Solicitamos evento -->
                  ...
                  <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="id_evento" id="id_evento">
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <button class="btn btn-primary documentacion-subir" data-category="comprobante" type="submit" id="btnGuardar">Registrar</button>
